...
var file$3 = "src/routes/index.svelte";
...
function create_fragment$3(ctx) {
  ...
  var t12;
  var current;
  var settingssvg_spread_levels = [
  /*svgProps*/
  ctx[0]];
  var settingssvg_props = {};

  for (var i = 0; i < settingssvg_spread_levels.length; i += 1) {
    settingssvg_props = assign(settingssvg_props, settingssvg_spread_levels[i]);
  }

  var settingssvg = new Settings({
    props: settingssvg_props,
    $$inline: true
  });
  var awardsvg_spread_levels = [
  /*svgProps*/
  ctx[0]];
  var awardsvg_props = {};

  for (var _i = 0; _i < awardsvg_spread_levels.length; _i += 1) {
    awardsvg_props = assign(awardsvg_props, awardsvg_spread_levels[_i]);
  }

  var awardsvg = new Award({
    props: awardsvg_props,
    $$inline: true
  });
  var runsvg_spread_levels = [
  /*svgProps*/
  ctx[0]];
  var runsvg_props = {};

  for (var _i2 = 0; _i2 < runsvg_spread_levels.length; _i2 += 1) {
    runsvg_props = assign(runsvg_props, runsvg_spread_levels[_i2]);
  }
  ...
  var block = {
    ...
    l: function claim(nodes) {
      var head_nodes = query_selector_all("[data-svelte=\"svelte-ufc3m5\"]", document.head);
    ...
    p: function update(ctx, _ref) {
      ...
      var settingssvg_changes = dirty &
      /*svgProps*/
      1 ? get_spread_update(settingssvg_spread_levels, [get_spread_object(
      /*svgProps*/
      ctx[0])]) : {};
      settingssvg.$set(settingssvg_changes);
      var awardsvg_changes = dirty &
      /*svgProps*/
      1 ? get_spread_update(awardsvg_spread_levels, [get_spread_object(
      /*svgProps*/
      ctx[0])]) : {};
      awardsvg.$set(awardsvg_changes);
      var runsvg_changes = dirty &
      /*svgProps*/
      1 ? get_spread_update(runsvg_spread_levels, [get_spread_object(
      /*svgProps*/
      ctx[0])]) : {};
